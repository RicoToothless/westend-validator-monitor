# Typhoon with Kilo <img align="right" src="https://storage.googleapis.com/poseidon/typhoon-logo.png">
...
Install Kilo guide [reference](https://github.com/squat/kilo#installing-on-kubernetes)

Download kgctl binary from GitHub [release](https://github.com/squat/kilo/releases)

In this case, we need to specify the `kilo.squat.ai/force-endpoint` annotation on node

Draw the network topology

```
./kgctl-darwin-amd64 graph | circo -Tsvg > cluster.svg
```

![cluster](docs/graphs/cluster.svg)
